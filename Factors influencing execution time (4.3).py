...
print(len(edge_possibility_FFN[0]))
...
#open community file to control the number of clusters
...
#change file to control number of communities
...
print(len(g_ffn.edges),len(g_ffn.nodes))
#nx.draw(g)
...
print(len(g_ba.edges),len(g_ba.nodes))
...
#re=ax.bar( x+0.1, [161.576,298.008,280.12,287.372], width=0.25,label=[i for i in ['FFN','BA','ER','SW']],hatch=["/" , "-" , "\\" , "x"],color='white',edgecolor='black');
