...
def APWP(edge,p,c):
    from Poisson_Binomial import P_poisson_binomial_approximation_v1
    import time
    '''
    input:
    ...
    #edge posibilities in the cluster
        ...
        for i in range(len(edge)):
            ...
            if edge_node1 in cluster and edge_node2 in cluster:
                E_c_in.append(edge_position[i])
                Ep_c_in.append(edge_possibility[i])
            
            # collect edges between community c
            
            elif edge_node1 in cluster or edge_node2 in cluster:
                E_c_bet.append(edge_position[i])
                Ep_c_bet.append(edge_possibility[i])
                
            # collect edges outside community c
            
            else:
                E_c_out.append(edge_position[i])
                Ep_c_out.append(edge_possibility[i])
        ...
        for i in range(N_E_c):
            P1.append(P_poisson_binomial_approximation_v1(i,Ep_c_in))
        P2=[]
        for i in range(N_E_bet):
            P2.append(P_poisson_binomial_approximation_v1(i,Ep_c_bet))
        P3=[]
        for i in range(N_E_out):
            P3.append(P_poisson_binomial_approximation_v1(i,Ep_c_out))
...
def PWP(edge,p,c):
    from Poisson_Binomial import P_poisson_binomial_original_v1
    import time
    ...
    #edge posibilities in the cluster
        ...
        P1=[]
        for i in range(N_E_c):
            P1.append(P_poisson_binomial_original_v1(i,Ep_c_in))
        P2=[]
        for i in range(N_E_bet):
            P2.append(P_poisson_binomial_original_v1(i,Ep_c_bet))
        P3=[]
        for i in range(N_E_out):
            P3.append(P_poisson_binomial_original_v1(i,Ep_c_out))
